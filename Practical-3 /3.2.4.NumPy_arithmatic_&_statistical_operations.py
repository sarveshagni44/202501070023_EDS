...
#1. Arithmetic Operations: Compute the element-wise sum, difference, and product of the two arrays.
#2. Statistical Operations:Calculate the mean, median, and standard deviation of array A.
#3. Bitwise Operations:Perform bitwise AND, bitwise OR, and bitwise XOR on the arrays (ex: Ai OR Bi).
